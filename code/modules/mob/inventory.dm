...
/mob/proc/equip_to_appropriate_slot(obj/item/W, qdel_on_fail = FALSE, indirect_action = FALSE)
	...
	if(!slot_priority)
		slot_priority = list( \
			...
			ITEM_SLOT_RE13_STORAGE1, ITEM_SLOT_RE13_STORAGE2, ITEM_SLOT_RE13_STORAGE3, ITEM_SLOT_RE13_STORAGE4, ITEM_SLOT_RE13_STORAGE5, ITEM_SLOT_RE13_STORAGE6,\
...
/obj/item/proc/equip_to_best_slot(mob/user)
	...
	var/static/list/equip_priorities = list(
		ITEM_SLOT_BELT,
		ITEM_SLOT_BACK,
		ITEM_SLOT_RE13_STORAGE1,
		ITEM_SLOT_RE13_STORAGE2,
		ITEM_SLOT_RE13_STORAGE3,
		ITEM_SLOT_RE13_STORAGE4,
		ITEM_SLOT_RE13_STORAGE5,
		ITEM_SLOT_RE13_STORAGE6,
		ITEM_SLOT_DEX_STORAGE,
		ITEM_SLOT_OCLOTHING,
		ITEM_SLOT_ICLOTHING,
	)
