/mob/living/basic/sunvoid_ship
	...
	var/atom/movable/screen/sunvoid_event/current_event
...
/mob/living/basic/sunvoid_ship/proc/pick_random_event()
	current_event = pick(/atom/movable/screen/sunvoid_event)
	current_event = new(null, hud_used)
	hud_used.always_visible_inventory += current_event
	hud_used.show_hud(hud_used.hud_version)
	current_event.run_animation()
